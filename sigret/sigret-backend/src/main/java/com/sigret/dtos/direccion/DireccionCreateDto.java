...
public class DireccionCreateDto {
    ...
    // Es obligatorio solo cuando se usa el endpoint directo de direcciones
    ...
    // Campos estructurados (pueden ser extraídos de Google Places o ingresados manualmente)
    ...
    // Objeto completo de Google Places (opcional, para procesamiento automático)
